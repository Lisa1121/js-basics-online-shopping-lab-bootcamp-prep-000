...
- // write your code here	+ var temp = item;
...
-  // write your code here	+  var temp = "In your cart, you have ";
  if (cart.length === 0) {
...
-  // write your code here	+  var inCart = false;
  var itemIndex = NaN;
  for (let i=0;cart.length>i;i++) {
...
-  // write your code here	+  if (cardNumber) {
